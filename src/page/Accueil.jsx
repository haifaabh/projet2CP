...
<div className={`${isSmallScreen ? "w-[68vh] h-[120px] top-[48vh] left-[5vh]" : "left-[75px] w-[90vh] top-[290px]"} absolute search-input`}>
  <div className="rounded-full bg-[#D9D9D9] p-4 flex items-center justify-start relative">
    <span className="icon-rech">
      <SearchIcon className="text-black " style={{ marginTop: "0px" }} />
    </span>
    <input
      type="text"
...
<img src={p3} alt=""  className={`${isSmallScreen ? "ml-[55vh] mt-[-9vh] " : "absolute "}  w-[120px] h-[120px] top-[190px] left-[530px]`} onClick={handleSearch} />




  <div  className={`${isSmallScreen ? "mt-[11vh] " : "mt-[11%]"} relative flex flex-row `} onClick={handleSearch}>
  <div className={`${isSmallScreen ? "mt-[10vh] ml-[5vh]" : "  left-[13vh] "} absolute`} onClick={handleSearch}>
...
Consulter
 ...
 <RouterLink to="/filtres4"> 
  <button className={`${isSmallScreen ? "w-[30vh] h-[50px]  ml-[43vh] mt-[10vh]" : " w-[210px] h-[50px] ml-[66vh] "} bg-[#99BFE4] hover:bg-[#57a3fb] rounded-[40px] text-black border-none text-[4vh] font-[Montserrat] font-bold`}  >
