...
return (
<div className= {`bg-[#AD98E9] h-[98vh] rounded-2xl mb-2 ml-2 mt-2 border transition-all duration-500 border-solid border-gray-300 relative ${toggle ? "w-[4.2rem]" : " w-[17rem]"}`}>
